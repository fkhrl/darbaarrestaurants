    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="site_basic_info_2"></div>
            </div>
        </div>
        <!-- // Site Basic Info END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},site_name: {type: "string"},top_logo: {type: "string"},logo: {type: "string"},email: {type: "string"},phone: {type: "string"},address: {type: "string"},keywords: {type: "string"},description: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#site_basic_info_2").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "site_name", title: "Site Name"},{field: "top_logo", title: "Top Logo"},{field: "logo", title: "Logo"},{field: "email", title: "Email"},{field: "phone", title: "Phone"},{field: "keywords", title: "Keywords"},
