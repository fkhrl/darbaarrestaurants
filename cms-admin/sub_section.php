...
{
	extract($_POST);if(!empty($category_id) && !empty($sub_category_id) && !empty($name) && !empty($priority))
	{$updatearray=array("id"=>$id);$upd2=array('category_id'=>$category_id,'sub_category_id'=>$sub_category_id,'name'=>$name,'priority'=>$priority,'date'=>date('Y-m-d'),'status'=>1);
	...
	<body class="">
		...
		<div id="content">
			<h1 class="content-heading bg-white border-bottom">Sub Section</h1>
			<div class="innerAll bg-white border-bottom">
				<ul class="menubar">
					<li class="active"><a href="#">Create New Sub Section</a></li>
					<li><a href="sub_section_data.php">Sub Section List</a></li>
				</ul>
			</div>
				...
				<div class="widget widget-inverse" >
					...
					if(isset($_GET['edit']))
					{
						...
						<div class="widget-head">
							<h4 class="heading">Update/Change - Sub Section</h4>
						</div>
						<!-- // Widget heading END -->
...
<!-- Widget heading -->
<div class="widget-head">
	<h4 class="heading">Create New Sub Section</h4>
</div>
<!-- // Widget heading END -->
...
<?php echo $plugin->TableJs(); $plugin->KendoJs(); ?></body>
</html>