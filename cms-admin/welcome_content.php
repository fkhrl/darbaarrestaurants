<?php 
		...
		if(isset($_POST['create'])){
			extract($_POST);
			if(!empty($name) && !empty($map) && !empty($short_details) && !empty($youtube_link))
			{  $insert=array('name'=>$name,'map'=>$map,'short_details'=>$short_details,'youtube_link'=>$youtube_link,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);if(!empty($name) && !empty($map) && !empty($short_details) && !empty($youtube_link))
			{$updatearray=array("id"=>$id);$upd2=array('name'=>$name,'map'=>$map,'short_details'=>$short_details,'youtube_link'=>$youtube_link,'date'=>date('Y-m-d'),'status'=>1);
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-body"><form  class="form-horizontal" method="post" action="" role="form">
								<input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
											...
											<div class='col-sm-9'>
												<input type='text' id='form-field-1' name='short_details' value='<?php echo $obj->SelectAllByVal($table,"id",$_GET['edit'],"short_details"); ?>' placeholder='Short Details' class='form-control' />
											</div>
										</div><div class='form-group'>
                            ...
                            <div class="widget-body"><form  class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
											...
											<div class='col-sm-9'>
												<input type='text' id='form-field-1' name='short_details' placeholder='Short Details' class='form-control' />
											</div>
										</div><div class='form-group'>
											<label  for="inputEmail3" class="col-sm-2 control-label"> Youtube Link </label>
