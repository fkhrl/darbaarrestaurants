    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="welcome_content_11"></div>
            </div>
        </div>
        <!-- // Welcome Content END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},name: {type: "string"},map: {type: "string"},short_details: {type: "string"},youtube_link: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#welcome_content_11").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "name", title: "Name"},{field: "map", title: "Map"},{field: "short_details", title: "Short Details"},{field: "youtube_link", title: "Youtube Link"},
