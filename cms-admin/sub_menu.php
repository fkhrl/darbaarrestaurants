...
if (isset($_POST['create'])) {
    ...
    if (!empty($category_id) && !empty($name)) {
        ...
        $upd2 = array('category_id' => $category_id, 'name' => $name, 'date' => date('Y-m-d'), 'status' => 1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
            <h1 class="content-heading bg-white border-bottom">Sub Menu</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Sub Menu</a></li>
                    <li><a href="sub_menu_data.php">Sub Menu List</a></li>
                </ul>
            </div>
                ...
                <div class="widget widget-inverse" >
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-head">
                            <h4 class="heading">Update/Change - Sub Menu</h4>
                        </div>
                        <!-- // Widget heading END -->
                    ...
                    <?php } else { ?>
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Create New Sub Menu</h4>
                        </div>
                        <!-- // Widget heading END -->
