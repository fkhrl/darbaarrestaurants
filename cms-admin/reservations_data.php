    ...
    <body class="">
        ...
        <div id="content">
            ...
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li><a href="reservations.php">Create New Reservations</a></li>
                    <li class="active"><a href="#">Reservations Data List</a></li>
                </ul>
            </div>
        ...
        <!-- // Sidebar menu & Reservations wrapper END -->
            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    jQuery("#reservations_6").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "name", title: "Name"},{field: "email", title: "Email"},{field: "phone", title: "Phone"},{field: "number_of_person", title: "Number Of Person"},{field: "reservations_date", title: "Reservations Date"},{field: "reservations_time", title: "Reservations Time"},{field: "message", title: "Message"},
